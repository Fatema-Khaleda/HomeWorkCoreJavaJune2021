...
public interface University {
	...
	because Interface can not have constructor
	 ...
	 Question 2/ answer how many keywords are used for the inheritance for Interface?
	 Answer: only 1 keywords are used for the inheritance for Interface.
	 
	 Question 3/ Can an interface inherit other Interface, or a regular class or abstract class? 
	 Answer: Yes- an interface inherit other Interface, but it can not inherit  a regular class or abstract class.
	 
	 Question 4/ How many inheritance is possible? 
	 Answer:  More than one interfaces can inherit by an interface by extends keywords.
